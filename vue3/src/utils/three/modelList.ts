...
// export const initSeat = (scene) => {
//   return new OBJLoader().setPath("/static/obj/").load("2.obj", (obj) => {
//     const seat = obj;
//     seat.position.set(0, 500, 0);
//     seat.scale.set(0.1, 0.1, 0.1);
//     scene.add(seat);
//   });
// };
