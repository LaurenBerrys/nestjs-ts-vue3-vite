...
const data={
  nodes:[
    {id:1,level:0,name:'知识集',label:'知识集',cname:'知识集',x:100,y:100,nodetype:'知识集',weight:20},
    {id:2,level:2,name:'知识点',label:'知识点',cname:'知识点',x:250,y:100,nodetype:'知识点',weight:20},
    {id:3,level:2,name:'知识块',label:'知识块',cname:'知识块',x:400,y:100,nodetype:'知识块',weight:20},
    {id:4,level:2,name:'属性点',label:'属性点',cname:'属性点',x:550,y:100,nodetype:'属性点',weight:20},
    {id:5,level:2,name:'资源节点',label:'资源节点',cname:'资源节点',x:700,y:100,nodetype:'资源节点',filetype:'图片',weight:20},
],
links:[
