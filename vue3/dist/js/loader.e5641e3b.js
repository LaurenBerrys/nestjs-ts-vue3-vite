import { hc as k, hd as y, he as a, hq as z } from "./index.8fd7165c.js";
import { g as b } from "./guid.416070ad.js";
const x = k(
  class extends y {
    constructor() {
      super(),
    ...
    render() {
      const {
        ...
        u = e.id || b(),
        i = v ? this.getInlineSize(l) : this.getSize(l),
        c = 0.45 * i,
        r = `0 0 ${i} ${i}`,
        n = h === "determinate",
        d = 2 * c * Math.PI,
      ...
      return a(
        ...
        a(
          ...
          a(
            ...
            {
              "aria-hidden": "true",
              class: "loader__svg loader__svg--1",
              viewBox: r,
            },
            a("circle", { ...o })
          ),
          a(
            ...
            {
              "aria-hidden": "true",
              class: "loader__svg loader__svg--2",
              viewBox: r,
            },
            a("circle", { ...o })
          ),
        ...
        s && a("div", { class: "loader__text" }, s),
        n && a("div", { class: "loader__percentage" }, t)
      );
    }
    getSize(e) {
