...
const Me = {
  ...
  dl = ie({
    ...
    setup(k) {
      const p = r(!0),
        M = {
          title: { required: !0, message: "请输入菜单名", trigger: "blur" },
          path: { required: !0, message: "请输入路径", trigger: "blur" },
        },
        t = re({
          parentId: 0,
          title: "",
      ...
      const V = de(() => !_.value.length),
        q = r([
          { label: "添加顶级菜单", key: "home", disabled: !1 },
          { label: "添加子菜单", key: "son", disabled: V },
        ]),
        A = r(null);
      function D() {
        delete t.children,
      ...
      const O = (o) => {
          (j.value = o === "home" ? "添加顶级菜单" : `添加子菜单：${f.value}`),
            P();
        },
        $ = r(),
        P = () => {
