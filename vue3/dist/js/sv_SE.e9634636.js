    ...
    Object.defineProperty(r, "__esModule", { value: !0 }),
      (r.default = {
        ...
        "Click, tap or press ENTER to toggle":
          "Klicka eller tryck ENTER för att ändra",
        Loading: "Läser in",
        Home: "Hem",
        Chart: "Diagram",
        ...
        "Use arrow keys to zoom in and out":
          "Använd pil-knapparna för att zooma in och ut",
        "Use plus and minus keys on your keyboard to zoom in and out":
          "Använd plus- och minus-knapparna för att zooma in och ut",
        Export: "Exportera",
        Image: "Bild",
        Data: "Data",
        Print: "Skriv ut",
        "Click, tap or press ENTER to open":
          "Klicka eller tryck ENTER för att öppna",
        "Click, tap or press ENTER to print.":
          "Klicka eller tryck ENTER för att skriva ut.",
        "Click, tap or press ENTER to export as %1.":
          "Klicka eller tryck ENTER för att exportera till %1.",
        'To save the image, right-click this link and choose "Save picture as..."':
          'För att spara bilden, höger-klicka länken och välj "Spara bild som..."',
        'To save the image, right-click thumbnail on the left and choose "Save picture as..."':
          'För att spara bilden, höger-klicka miniatyrbilden till vänster och välj "Spara bild som..."',
        ...
        "Use left and right arrows to move selection":
          "Använd vänster och höger pilknappar för att flytta urvalet",
        "Use left and right arrows to move left selection":
          "Använd vänster och höger pilknappar för att flytta vänsterurval",
        "Use left and right arrows to move right selection":
          "Använd vänster och höger pilknappar för att flytta högerurval",
        "Use TAB select grip buttons or up and down arrows to change selection":
          "",
        "Use up and down arrows to move selection":
          "Använd upp och ner pilknappar för att flytta urvalet",
        "Use up and down arrows to move lower selection":
          "Använd upp och ner pilknappar för att flytta nedre urvalet",
        "Use up and down arrows to move upper selection":
          "Använd upp och ner pilknappar för att flytta övre urvalet",
