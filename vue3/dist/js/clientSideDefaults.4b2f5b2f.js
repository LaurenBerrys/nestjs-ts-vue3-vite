...
import { t as c } from "./QueryEngineCapabilities.42e44ded.js";
function h(t) {
  return {
    renderer: {
      type: "simple",
      symbol:
        t === "esriGeometryPoint" || t === "esriGeometryMultipoint"
          ? o
...
function $(t = {}) {
  return [
    { name: "New Feature", description: "", prototype: { attributes: i(t) } },
  ];
}
function f(t, s) {
  return {
...
export { $ as a, A as i, f as l, h as o };
